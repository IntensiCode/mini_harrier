...
import 'package:mini_harrier/game/auto_shadows.dart';
import 'package:mini_harrier/game/mini_effects.dart';
...
import 'floating_captain.dart';
import 'ufo_enemies.dart';

class HarrierStage1 extends MiniScriptComponent with HasAutoDisposeShortcuts {
  @override
  void onLoad() async {
    super.onLoad();
    ...
    final captain = FloatingCaptain(world: world);
    ...
    at(0.0, () => captain.state = FloatingCaptainState.playing);
  }
}

class _CameraMovement extends Component {
  FloatingCaptain? follow;
